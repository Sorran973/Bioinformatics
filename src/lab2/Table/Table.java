...
import lab2.Matrixes.IMatrix;
import lab2.Sequence.Sequence;
...
public class Table {
    ...
    public void showResults(PrintStream printTo) {
        ...
        printTo.println();
        resTable[seqB.size()][seqA.size()].printAlignment(printTo);
        printTo.println("Score: " + resTable[seqB.size()][seqA.size()].getScore());
    }
